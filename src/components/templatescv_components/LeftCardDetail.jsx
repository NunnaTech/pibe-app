			...
			<Card className="sm:w-auto md:w-6 lg:w-6 h-auto shadow-4 m-5">
				...
				<div className="grid container">
					...
					<div >
						...
						<div className="grid container mt-2 md:ml-6 lg:ml-6  ">
							<div className="col-4 md:col-4 lg:col-4 justify-content-center">
								<Button style={{ color: "white" }} icon={<span className="material-icons m-0">call</span>}
							...
							<div className="col-4 md:col-4 lg:col-4 justify-content-center">
								<Button style={{ color: "white" }} icon={<span className="material-icons m-0">mail</span>}
									className="p-button-rounded p-button-help p-button-plain " />
								<div className="text-base font-light text-600 flex justify-content-center mt-2 ">juan@utez.edu.mx</div>
							</div>
							<div className="col-4 md:col-4 lg:col-4 flex flex-wrap align-items-center justify-content-center">
								<Button style={{ color: "white" }} icon={<span className="material-icons m-0">my_location</span>}
									className="p-button-rounded p-button-help p-button-plain " />
