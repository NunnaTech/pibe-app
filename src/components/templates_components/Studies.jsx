            ...
            <div className=" px-5 m-0 md:m-5">
                <div class="card ">
                    <div class="flex flex-wrap align-items-center mt-3 justify-content-center card-container blue-container">
                        <div class="min-w-full border-round bg-blue-900  text-white font-bold p-1 flex align-items-center text-left">Estudios:</div>
                    </div>
                    <div class="min-w-full text-justify border-round  font-bold mt-2 flex align-items-center text-left md:ml-3 lg:ml-3 md:mr-3 lg:mr-3">Universidad Tecnológica Emiliano Zapata UTEZ</div>
