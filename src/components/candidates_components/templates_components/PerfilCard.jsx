				...
				<div className='grid '>
					<div className='col-12'>
						<div className='flex justify-content-center '>
							<img
								className='flex justify-content-center sm:w-2 sm:h-2    shadow-4 border-circle'
								src={`https://avatars.dicebear.com/api/initials/${userSession.username}.svg`}
							/>
						</div>
						{
							<div className='text-base  font-light text-600 mt-2  text-center lg:ml-4 p-5 py-0 m-3'>
					...
					<div className='col-12'>
						{
							<div className='flex justify-content-center text-2xl mt-1 font-bold'>
								{resume.profile.name.concat(
									' ',
									resume.profile.firstName,
									' ',
									resume.profile.secondName,
								)}
							</div>
						}
						<div class='card '>
							<div
								class={`flex flex-wrap align-items-center mt-3 justify-content-center card-container ${color}`}>
						...
						<div className='grid  mt-2'>
							<div className='col-4 '>
								...
								{
									<div className='text-sm font-light text-600 flex justify-content-center mt-2 '>
							...
							<div className=' col-4'>
								...
								<div className='text-sm font-light text-600 flex justify-content-center mt-2 mx-6'>
									{userSession.email}
								</div>
							</div>
							<div className='col-4   '>
								<div className='text-base font-bold mt-2 flex justify-content-center'>
									<Button
										style={{ color: 'white' }}
										icon={<span className='material-icons '>my_location</span>}
										className={`p-button-rounded ${color} p-button-plain  `}
									/>
								</div>
								{
