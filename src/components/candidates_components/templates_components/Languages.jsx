						...
						{resume.languages.map((r, i) => {
							return (
								<div className='col-12 '>
									<div className='text-base text-justify mt-2 font-bold  md:ml-3 lg:ml-3 md:mr-3 lg:mr-3 '>
										• {r.language.language}{' '}
									</div>
									<div className='text-base text-justify  font-light text-600 md:ml-3 lg:ml-3 md:mr-3 lg:mr-3'>
										{' '}
										{r.level}
									</div>
								</div>
